    ...
    return (
        ...
        >
            ...
            <div className="relative w-full aspect-square flex-shrink-0">
                ...
                {isHighRisk && (
                    <div className="absolute top-1.5 left-1.5 bg-[#EF4444] text-white text-[0.6rem] font-bold px-1.5 py-0.5 rounded-sm flex items-center gap-1 shadow-sm">
            ...
            <div className="p-2 pb-0 flex flex-col flex-1">
                <div className="flex justify-between items-center mb-1.5 border-b border-slate-100 pb-1">
                    ...
                    <span className="text-[0.6rem] text-slate-400 font-bold">{idol.age}세 • {idol.gender === 'male' ? '남' : '여'}</span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-x-2 gap-y-1.5 text-[0.55rem] font-bold text-slate-600 mb-2 bg-slate-50/70 p-1.5 rounded-md border border-slate-100">
                    <div className="flex items-center justify-between">
                        <span className="shrink-0 whitespace-nowrap mr-1 text-[0.52rem]">댄스</span>
                    ...
                    <div className="flex items-center justify-between">
                        <span className="shrink-0 whitespace-nowrap mr-1 text-[0.52rem]">보컬</span>
                        <div className="flex-1 h-1 bg-white rounded-full overflow-hidden border border-slate-100/50">
                    ...
                    <div className="flex items-center justify-between">
                        <span className="shrink-0 whitespace-nowrap mr-1 text-[0.52rem]">비주얼</span>
                        <div className="flex-1 h-1 bg-white rounded-full overflow-hidden border border-slate-100/50">
                    ...
                    <div className="flex items-center justify-between">
                        <span className="shrink-0 whitespace-nowrap mr-1 text-[0.52rem]">잠재력</span>
                ...
                <div className="mt-auto space-y-1">
                    <div className="flex flex-col gap-0.5 px-0.5 mb-1">
                        <span className="text-[0.55rem] font-bold text-slate-400">구설수 / 열애설 / 분쟁</span>
                    ...
                    <p className="text-[0.58rem] text-slate-500 font-medium italic border-t border-slate-50 pt-1 px-0.5 leading-[1.2]">
                        "{idol.geminiAnalysis}"
                    </p>
                </div>
            </div>
