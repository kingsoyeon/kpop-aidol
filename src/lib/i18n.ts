...
export const copyByLocale: Record<Locale, I18nDict> = {
    ko: {
        ...
        studio: {
            ...
            staff: {
                title: 'AI Staff 브리핑',
                analysisEngine: 'Gemini 분석 엔진',
                analysisTime: '분석 시간: 리얼타임',
                lyrics: '가사 (일부)',
                listen: '오디오 미리듣기',
                ar: 'A&R 어드바이저',
                marketing: '마케팅 어드바이저',
                finance: '재무 어드바이저',
                arPreview: '컴백 컨셉과 곡 구성에 대한 향주가 완료됐습니다.',
                marketingPreview: '타겟 시장별 마케팅 전략이 준비됐습니다.',
                financePreview: '제작 비용 및 ROI 분석이 완료됐습니다.',
                arDetail: 'A&R 어드바이저는 선택된 컨셉과 타겟 시장이 혁리적으로 연대된다고 평가합니다. 멤버들의 마이크 컨트롤 역량이 이번 컨셉에서 특히 빛나는 구성입니다.',
                marketingDetail: '마케팅 팀은 SNS 바이럴 콘텐츠 전략과 포토스팟 예약을 완료했습니다. 틱톡 선곡 공모와 스폰서스 연계를 추진 중입니다.',
                financeDetail: '이번 컴백의 총 제작 비용 대비 예상 ROI는 깨나멘 결과일 경우 328% 입니다. 깎청한 성적 시에도 수익 평형점에 도달할 수 있는 안전한 투자입니다.',
                recBadge: 'REC',
                recConcept: 'AI 최적 컨셉',
                recMarket: 'AI 최적 시장',
                slideshow: '라이브캠 슬라이드쇼',
                livecam: '라이브캠',
            }
        },
        musicshow: {
    ...
    en: {
        ...
        studio: {
            ...
            staff: {
                title: 'AI Staff Briefing',
                analysisEngine: 'Gemini Analysis Engine',
                analysisTime: 'Analysis: Real-time',
                lyrics: 'Lyrics (excerpt)',
                listen: 'Audio Preview',
                ar: 'A&R Advisor',
                marketing: 'Marketing Advisor',
                finance: 'Finance Advisor',
                arPreview: 'Concept & track composition analysis complete.',
                marketingPreview: 'Market-specific strategy ready.',
                financePreview: 'Production cost & ROI analysis complete.',
                arDetail: 'The A&R advisor evaluates the selected concept and target market as a powerful match. The members vocal control ability shines in this concept.',
                marketingDetail: 'Marketing team has completed SNS viral content strategy and photoshoot bookings. TikTok challenge and sponsorship connections are in progress.',
                financeDetail: 'Expected ROI for this comeback is 328% vs. total production cost. Even in a modest performance scenario, the break-even point is reachable.',
                recBadge: 'REC',
                recConcept: 'AI Best Concept',
                recMarket: 'AI Best Market',
                slideshow: 'Livecam Slideshow',
                livecam: 'LIVECAM',
            }
        },
        musicshow: {
